                        ...
                        <form class="md-float-material">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <label for="" class="text-left text-dark ">Prenom</label>
                                    <input type="text" class="form-control mt-4 mr-45" placeholder="prenom">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <label for="" class="text-left text-dark ">Nom</label>
                                    <input type="text" class="form-control mt-4 mr-45" placeholder="nom">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <label for="" class="text-left text-dark ">CNI</label>
                                    <input type="text" class="form-control mt-4 mr-45" placeholder="Numero carte d'identite">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <label for="" class="text-left text-dark ">Login</label>
                                    <input type="text" class="form-control mt-4 mr-45" placeholder="login">
                                    <span class="md-line"></span>
                                </div>
