@extends('Layouts/App')
@section('content')
<button class="btn btn-success offset-11" data-bs-toggle="modal" data-bs-target="#exampleModal1">Ajouter</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <label> Date de sortie <span class="font-weight-bold ml-2"><input type="date" class="form-control"></span></label>
          <label> Matricule <span class="font-weight-bold ml-2"><input type="text" class="form-control"></span></label>
          <label> Kilometrage <span class="font-weight-bold ml-2"><input type="text" class="form-control"></span></label>
          <label> N Permis <span class="font-weight-bold ml-2"><input type="text" class="form-control"></span></label>
          <label> Categorie <span class="font-weight-bold ml-2">
